    ...
    return (
        <AuthenticatedLayout>
            <div className="grid grid-cols-2 justify-items-center px-40 gap-y-20">
                <div className="border-4 rounded-lg border-gray-200 px-10 pt-6 space-y-8">
                    ...
                    <div className="overflow-auto max-h-[460px] space-y-7">
                ...
                <div className="col-span-2 overflow-auto border-4 rounded-lg border-gray-200 px-10 pt-8 space-y-8">
                    <h3 className="font-poppins font-bold text-bluemike text-xl">Ocorrências finalizadas</h3>
                    <div className="grid grid-cols-2 gap-x-24 overflow-auto max-h-[460px] gap-y-7">
